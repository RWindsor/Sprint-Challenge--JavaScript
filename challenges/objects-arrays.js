...
const universities = graduates.map(function(a){
...
const contactInfo = graduates.map(function(a){
...
const uni = graduates.filter(function(a){
  return a.university == a.university.substring('Uni');
});
console.log(uni);
...
*/
const animalNames = zooAnimals.forEach(function(a){
  return a.animal_name + ' ' + a.scientific_name;
})
...
*/
const largerPopulation = zooAnimals.filter(function (a){
